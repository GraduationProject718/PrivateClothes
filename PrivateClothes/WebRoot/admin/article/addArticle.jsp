...
<html>
  ...
  <body>
	<form action="${pageContext.request.contextPath}/ArticleServlet?method=addArticle" method="post" enctype="multipart/form-data">
	...
	<textarea name="content" id="content" style="width: 100%; height: 70%;margin:0 auto;"></textarea>
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body">
	 				<label>输入标题</label><input class="layui-input" type="text" name="title" id="title" ><br />
					<label>输入时间</label><input class="layui-input" type="text" name="date" id="date"><br />
					<label>上传封面</label><input class="layui-input" type="file" name="img" id="img" ><br />
				</div>
