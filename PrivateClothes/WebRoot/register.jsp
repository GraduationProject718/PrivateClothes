  ...
  <body>
    <div class='login'>
	  <div class='login_title'>
	    <a href="index.jsp" style="color:#2fa0ec;">服装私人定制网</a>
	  </div>
	  <div class='login_fields'>
	    <div class='login_fields__user'>
	      ...
	      <input name="login" placeholder='用户名' maxlength="30" type='text' autocomplete="off" placeholder='请输入账号'/>
	    ...
	    <div class='login_fields__password'>
	      ...
	      <input name="pwd" placeholder='请输入密码' maxlength="30" type='text' autocomplete="off">
	      <div class='validation'>
	        <img alt="" src='images/tick.png'>
	      </div>
	    </div>
	    ...
	    <div class='login_fields__submit'>
	      <input type='button' value='登录'><a href="register.jsp"><input type='button' value='注册'></a>
	    </div>
